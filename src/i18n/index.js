...
const translations = {
  en: {
    ...
    profile: {
      ...
      photo_error: 'Failed to pick image',
      saving: 'Saving...',
  ...
  sq: {
    ...
    profile: {
      title: 'Profili',
      loading: 'Duke ngarkuar profilin...',
      error_load: 'Dështoi në ngarkimin e profilit',
      name: 'Emri',
      name_placeholder: 'Shkruani emrin tuaj',
      email: 'Email',
      email_placeholder: 'Shkruani emailin tuaj',
      first_name: 'Emri',
      first_name_placeholder: 'Shkruani emrin tuaj',
      last_name: 'Mbiemri',
      last_name_placeholder: 'Shkruani mbiemrin tuaj',
      date_of_birth: 'Data e lindjes',
      address: 'Adresa',
      address_placeholder: 'Shkruani adresën tuaj',
      change_photo: 'Ndrysho Foton',
      photo_error: 'Dështoi në zgjedhjen e fotos',
      saving: 'Duke ruajtur...',
      save_changes: 'Ruaj Ndryshimet',
      updated_success: 'Profili u përditësua me sukses',
      update_failed: 'Dështoi në përditësimin e profilit',
      avatar_preview: 'Pamja paraprake e fotos së profilit',
      remove: 'Hiq',
      back: 'Kthehu',
    },
    posts: 'Postimet',
